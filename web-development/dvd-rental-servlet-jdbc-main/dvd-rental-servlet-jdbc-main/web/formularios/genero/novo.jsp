...
<html>
 ...
 /* Ícone do menu lateral (hamburger) */
            ...
            .container {
                ...
                padding: 30px 40px; /* ajustado para ficar proporcional */
                border-radius: 20px;
                width: 90%;
                max-width: 500px;
            ...
            h1 {
                ...
                font-size: 32px;
                text-align: center;
                margin-bottom: 25px; /* levemente menor */
            }
            ...
            table th, table td {
                padding: 10px 5px; /* reduzido para ficar proporcional */
                text-align: left;
            }

            .alinharDireita {
                text-align: right;
                padding-right: 15px; /* ajustado */
                font-weight: bold;
            }
