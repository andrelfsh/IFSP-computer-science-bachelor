        ...
        <form method="post" action="${cp}/processaDvd">
            ...
            <table>
                <tr>
                    ...
                    <td><input name="titulo" type="text" maxlength="100" required/></td>
                </tr>
                <tr>
                    <td class="alinharDireita">Ano de lançamento:</td>
                    <td><input name="ano_lancamento" type="number" required/></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><input name="duracao" type="number" required/></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <input name="foto_url" type="text" maxlength="255" required/> 
                    </td>
                </tr>
                <tr>
                    <td>
