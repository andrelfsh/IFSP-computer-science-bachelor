...
<body>
    ...
    <!-- Container central com formulário -->
    <div class="container">
        <h1>Alterar Ator</h1>
        ...
        <form method="post" action="${cp}/processaAtor">
            ...
            <table>
                <tr>
                    ...
                    <td>
                        <input name="nome" type="text" maxlength="30" value="${requestScope.ator.nome}"/>
                    </td>
                </tr>
                <tr>
                    <td class="alinharDireita">Sobrenome:</td>
                    <td>
                        <input name="sobrenome" type="text" maxlength="30" value="${requestScope.ator.sobrenome}"/>
                    </td>
                </tr>
                <tr>
                    <td class="alinharDireita">Data do primeiro filme:</td>
                    <td>
                        <input name="data" type="date" value="${requestScope.ator.data_estreia}"/>
                    </td>
                </tr>
                <tr>
                    <td>
