        ...
        <form method="post" action="${cp}/processaAtor">
            ...
            <table>
                <tr>
                    ...
                    <td><input name="nome" type="text" maxlength="30" required/></td>
                </tr>
                <tr>
                    <td class="alinharDireita">Sobrenome:</td>
                    <td><input name="sobrenome" type="text" maxlength="30" required/></td>
                </tr>
                <tr>
                    <td class="alinharDireita">Data do primeiro filme:</td>
                    <td><input name="data" type="date" required/></td>
                </tr>
                <tr>
                    <td>
                        <button type="button" onclick="window.location.href='${cp}/formularios/ator/listagem.jsp'">Voltar</button>
                    </td>
