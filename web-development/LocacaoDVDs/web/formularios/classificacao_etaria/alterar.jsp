...
<html>
  ...
  <!-- Google Fonts -->
    ...
    <style>
        ...
        input[type="submit"]:hover { background-color: #97b1f7; }
...
<body>
    ...
    <!-- Container semi-transparente -->
    <div class="container">
        <h1>Alterar classificacao etaria</h1>
        ...
        <form method="post" action="${cp}/processaClassificacao">
            ...
            <table>
                <tr>
                    ...
                    <td>
                        <input name="descricao" type="text" size="20" maxlength="30" value="${requestScope.classificacao_etaria.descricao}"/>
                    </td>
                </tr>
                <tr>
                    <td>
                         <button type="button" class="botaoVoltar" onclick="window.location.href = '${cp}/formularios/classificacao_etaria/listagem.jsp'">
                                Voltar
                            </button>
                    </td>
